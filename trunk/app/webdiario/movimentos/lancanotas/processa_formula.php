...
else  
{
   ...
   else 
   {
	  ...
	  $queryup =  pg_exec($dbconnect, $sqlup);
	...
	//  echo '<br /><br />' . $qryDiario;
     ...
     else
     {
		 ...
		 print '<script language=javascript>  window.alert("Diário iniciado com sucesso!"); </script>';
       	echo '<html> <body> <script type="text/javascript"> self.location.href = "lancanotas2.php?id=' .$id. '&disc=' . $getdisciplina . '&ofer=' . $getofer. '&getperiodo=' . $getperiodo. '" </script> </body> </html>';
