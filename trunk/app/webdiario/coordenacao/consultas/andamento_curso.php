...
<table width="90%" height="73" border="0">
              <tr>
            <td width="471"><div align="center"><font color="#990000" size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>Resumo de Notas e Faltas do Curso</strong></font></div></td>
            </tr></table>
		      ...
		      <h4><font color="orange"><b>Curso: </b></font><font color="blue"><?php echo $msg; ?></font></h4>
				...
				<?php
					...
					if(strlen($msg) > 0 && isset($_SESSION['select_curso'])) {
						...
						//		echo '<a href="'.$BASE_URL.'consultas/andamento_consulta.php?t=0">Ver Resumo da turma</a>';
								...
								//echo '<br />';
								//echo '<a href="#" onclick="javascript:open_win(\''.$BASE_URL.'consultas/andamento_consulta.php?t=0\');">Teste </a>';
									//echo '<a href="'.$BASE_URL.'consultas/andamento_consulta.php?t=0">Ver Resumo da turma</a>';
							}
							echo '<br />';
      					}
