...
<body bgcolor="#FFFFFF">
<form method="post" action="lista_dispensas.php" name="form1" target="_blank">
<h2>Relat&oacute;rio de Alunos Dispensados</h2>
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td width="68" align="center">
    <label class="bar_menu_texto">
        <input name="input" type="image" src="../../public/images/icons/print.jpg" alt="Exibir" onclick="submit_opt('lista_dispensados.php');"/>
        <br />
    Exibir</label>
</td>
