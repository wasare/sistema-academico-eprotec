...
function ListaAlunosDia($id_periodo, $id_curso, $id_campus)
{
   $conn = new Connection;
   ...
   $sql = " select distinct " .
          ...
          "       A.ref_curso='$id_curso' and " .
          "       A.ref_campus='$id_campus' " .
          " group by A.ref_campus, get_campus(A.ref_campus), A.ref_curso, curso_desc(A.ref_curso), C.dia_semana, C.turno " .
   ...
   while( $query->MoveNext() )
   {
     ...
     $href1 = "<a href=\"javascript:Lista_Alunos_Curso('$ref_curso', '$ref_campus', '$id_periodo', '$dia', '$turno')\"> " . $curso . "</a>";
     ...
     if ($i == 1)
     {
         echo ("<td bgcolor=\"#000099\" colspan=\"7\" height=\"28\" align=\"center\"><font size=\"3\" face=\"Verdana, Arial, Helvetica, sans-serif\" color=\"#FFFFFF\"><b>Número de Matriculados por Período/Curso/Campus/Dia da Semana/Turno</b></font></td>");
         echo ("<tr>");
...
function Lista_Alunos_Curso(ref_curso, ref_campus, ref_periodo, dia, turno)
{
  var url = "lista_alunos_curso_dia.php3" +
...
<script language="PHP">
    ListaAlunosDia($periodo_id, $curso_id, $campus_id);
</script>
<div align="center"> 
