...
<script language="PHP">
function ListaAlunos($ref_disciplina_ofer, $nome_prof, $dt_livro_matricula, $anterior)
{
   $conn = new Connection;
   ...
   $sql = " select A.ref_pessoa, " .
          ...
          " where A.ref_disciplina_ofer='$ref_disciplina_ofer' and " .
          "       A.ref_pessoa=B.id and " .
    	  "       A.obs_aproveitamento = '' and ";
          
          if ($anterior)
          {
            $sql .= " (A.dt_cancelamento is null or A.dt_cancelamento > '$dt_livro_matricula') ";
          }
          else
          {
            $sql .= " A.dt_cancelamento is null ";
          }
          
   $sql.= " order by A.ref_curso, " .
	      "	         pessoa_nome(A.ref_pessoa);" ;
...
<script language="PHP">
   ListaAlunos($ref_disciplina_ofer, $nome_prof, $dt_livro_matricula, $anterior);
</script>
<div align="center"> 
