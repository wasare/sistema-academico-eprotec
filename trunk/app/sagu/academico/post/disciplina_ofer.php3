...
<?
    ...
    $sql = " insert into disciplinas_ofer (" .        // Disciplina_ofer
           "         id," .
           "         ref_campus," .
           "         ref_curso," .
           "         ref_periodo," .
    ...
    $sql = " insert into disciplinas_ofer_compl (" .       // Disciplina_ofer_compl
           "	     id, " .
           "         ref_disciplina_ofer," .
           "         dia_semana," .
           "         turno," .
...
<form method="post" action="" name="myform">
  <table width="90%" align="center">
    <tr bgcolor="#000099"> 
      <td height="40" colspan="2" align="center"> <font face="Verdana, Arial, Helvetica, sans-serif" color="#CCCCFF" size="3"><b>&nbsp;Disciplinas Oferecidas</b></font></td>
    </tr>
    </tr>
    <tr align="center"> 
    ...
    <tr> 
      <td bgcolor="#CCCCFF" width="30%"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#00009C">&nbsp;Turma</font></td>
      <td bgcolor="#FFFFFF" width="70%"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#00009C"><b><?echo($turma);?><i>(<?echo($ref_periodo_turma);?>)</i></b></font>
      </td>
    </tr>
    <tr> 
  ...
  <table cols=2 width="90%" align="center">
    <tr align="center"> 
      <td colspan="2"> 
    	...
    	<input type="button" name="Submit" value=" Incluir outra Ocorrência" onClick="javascript:Inclui_Complemento('<? echo($id_disciplina_ofer)?>','<?echo($ref_campus);?>','<?echo($ref_curso);?>','<?echo($ref_periodo);?>','<?echo($ref_disciplina)?>','<? echo($num_alunos)?>','<? echo($fixar_num_sala)?>','<? echo($conteudo)?>')"></font>
    </tr>
    <tr align="center"> 
      <td colspan="2"> 
        <hr size="1">
