  ...
  <table width="778" border="0" cellspacing="0" cellpadding="0">
    ...
    <form method="post" action="lote.php">
      <table cellspacing="0" cellpadding="0"  class="pesquisa">
        <tr>
          <th colspan="2" align="center"> Filtro Matrícula por Lote</th>
        </tr>
        <tr>
          <td width="109"> </td>
          <td width="329"> </td>
        ...
        <tr>
          ...
          <td>
		  <?php
			$form = new clsFormulario;
		  	echo $form->PreencheCombobox("periodos","periodos","SELECT id, descricao FROM periodos"); 
		  ?>
            </td>
        </tr>
        <tr>
          <td><div align="left">Curso:</div></td>
          <td><input name="curso" id="curso" size="10" type="text" style="width:60px;" /></td>
        </tr>
        <tr>
          <td width="109"> </td>
          <td width="329"> </td>
