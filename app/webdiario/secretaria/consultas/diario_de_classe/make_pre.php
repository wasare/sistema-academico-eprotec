...
$sql2 = "select distinct dia from diario_seq_faltas where dia like '$vardate' and disciplina = '$getdisciplina' and periodo = '$getperiodo'";
...
$sql3="select b.nome, b.ra_cnec, a.ordem_chamada, ref_motivo_cancelamento, dt_cancelamento from matricula a, pessoas b where a.ref_periodo='$getperiodo' and a.ref_disciplina='$getdisciplina' and a.ref_pessoa=b.id order by ordem_chamada" . "$mais" ; 
...
<tr>
     <td colspan="2" align="center"><font size="2"><b><?print("$getperiodo / ");
...
while($row3=pg_fetch_array($query3)) {
	...
	$a=$datas[$x];
	$sql1 = "select data_chamada, ra_cnec, aula, abono, ref_disciplina from diario_chamadas where data_chamada='$a' and ref_periodo = '$getperiodo' and ref_disciplina = '$getdisciplina' and ra_cnec = '$ra_cnec' and aula = '0'";
