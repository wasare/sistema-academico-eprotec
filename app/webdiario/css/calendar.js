...
fontStyle        = "12px tahoma, verdana, arial, helvetica";           // TEXT STYLE FOR DATES
headingFontStyle = "bold 12px tahoma, verdana, arial, helvetica";      // TEXT STYLE FOR WEEKDAY ABBREVIATIONS
...
function buildTopCalFrame() {
	...
	var calDoc =
		...
		"<CENTER>" +
		getMonthSelect() +
		"&nbsp;<INPUT STYLE='font: " + fontStyle + "' NAME='year' VALUE='" + calDate.getFullYear() + "'TYPE=TEXT SIZE=4 MAXLENGTH=4 onChange='parent.opener.setYear()'>" +
		"</CENTER>" +
		"</TD>" +
		"</TR>" +
		"<TR>" +
		"<TD COLSPAN=7>" +
		"<INPUT " +
		" STYLE='font: " + fontStyle + "; border: black 1px solid;' TYPE=BUTTON NAME='previousYear' VALUE='<<'    onClick='parent.opener.setPreviousYear()'><INPUT " +
		" STYLE='font: " + fontStyle + "; border: black 1px solid;' TYPE=BUTTON NAME='previousMonth' VALUE=' < '   onClick='parent.opener.setPreviousMonth()'><INPUT " +
		" STYLE='font: " + fontStyle + "; border: black 1px solid;' TYPE=BUTTON NAME='today' VALUE='Today' onClick='parent.opener.setToday()'><INPUT " +
		" STYLE='font: " + fontStyle + "; border: black 1px solid;' TYPE=BUTTON NAME='nextMonth' VALUE=' > '   onClick='parent.opener.setNextMonth()'><INPUT " +
		" STYLE='font: " + fontStyle + "; border: black 1px solid;' TYPE=BUTTON NAME='nextYear' VALUE='>>'    onClick='parent.opener.setNextYear()'>" +
		"</TD>" +
		"</TR>" +
		"</TABLE>" +
		"</CENTER>" +
...
function getMonthSelect() {
	...
	monthSelect = "<SELECT STYLE='font: " + fontStyle + "' NAME='month' onChange='parent.opener.setCurrentMonth()'>";
...
function buildCalParts() {
	...
	calendarBegin =
		...
		"A { color: " + dateColor + "; text-decoration: none; font: " + fontStyle + "; }" +
