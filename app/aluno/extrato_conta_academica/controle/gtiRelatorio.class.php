...
class gtiRelatorio extends FPDF
{
	...
	public function Header()
	{
		...
		$this->Image('../visao/imagens/logo.jpg',160,10,40);

	    $this->SetFont('Arial','B',10);

	    $this->Cell(201,10,'SICAD Beta - Sistema para Cadastramento de Atividades Docentes',0,0,'L');
	    $this->Ln(5);

	    $this->Cell(205,10,'CENTRO FEDERAL DE EDUCAÇÃO TECNOLÓGICA DE BAMBUÍ - MG',0,0,'L');
	    $this->Ln(2);
