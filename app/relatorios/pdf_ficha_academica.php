...
<b>Matr&iacute;cula: </b><?php echo($ras);?> <b> Nome: </b><?php echo($_GET['nome']);?><br>
<b>Curso: </b><?php echo($_GET['curso']);?><br />
<b>Data: </b> <?php echo date("d/m/Y"); ?> <b>Hora: </b><?php echo date("H:i"); ?><br>
<br>
<table width="80%" cellpadding="0" cellspacing="0" class="tabela_relatorio">
  <tr bgcolor="#666666">
