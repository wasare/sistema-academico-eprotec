...
function Mostra_Matricula() {
	...
	while ($query->MoveNext()) {
		list ($id, $desc_disciplina, $nota_final, $dia_semana, $num_sala, $ref_disciplina, $dt_cancelamento, $ref_campus, $fl_liberado, $num_creditos, $turno, $conceito, $ref_periodo, $professor, $ref_disciplina_ofer, $fl_internet, $status_disciplina, $obs_aproveitamento, $ref_curso) = $query->GetRowValues();
		...
		if ($i == 1) {
			...
			echo ("<th width=\"9%\" align=\"center\">Status</td>");
...
function Mostra_Matricula_Geral() {
	...
	while ($query->MoveNext()) {
		list ($id, $curso_desc, $desc_disciplina, $nota_final, $dia_semana, $num_sala, $ref_disciplina, $dt_cancelamento, $ref_campus, $ref_campus_contrato, $fl_liberado, $num_creditos, $conceito, $ref_periodo, $professor, $ref_curso, $status_disciplina, $fl_internet, $obs_aproveitamento) = $query->GetRowValues();
...
<div style="width: 760px;" align="center">
  ...
  <form method="post" action="" name="myform">
    <h3>Disciplinas Matriculadas - <?php echo $periodo; ?></h3>
