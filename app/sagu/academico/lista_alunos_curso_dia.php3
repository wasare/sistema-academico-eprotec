...
<html>
<head>
<title>Lista de Alunos por Curso e por Dia</title>

<script language="PHP">
function ListaAlunos($ref_curso, $ref_campus, $ref_periodo, $dia_semana, $turno)
{
   $conn = new Connection;
...
$query = $conn->CreateQuery($sql);
   ...
   while( $query->MoveNext() )
   {
     ...
     if ($i == 1)
     {
         echo ("<td bgcolor=\"#000099\" colspan=\"6\" height=\"28\" align=\"center\"><font size=\"3\" face=\"Verdana, Arial, Helvetica, sans-serif\" color=\"#FFFFFF\"><b>Lista de Matriculados por Periodo/Curso/Campus/Dia da Semana/Turno</b></font></td>");
         echo ("<tr>");
         echo ("<td bgcolor=\"#000099\" colspan=\"6\" height=\"28\"> <font size=\"3\" face=\"Verdana, Arial, Helvetica, sans-serif\" color=\"#FFFFFF\"><b>Curso: $ref_curso - $curso_desc</b></font></td>");
         echo ("</tr>");
         echo ("<tr>");
...
<script language="PHP">
    ListaAlunos($ref_curso, $ref_campus, $ref_periodo, $dia_semana, $turno);
</script>
<div align="center"> 
