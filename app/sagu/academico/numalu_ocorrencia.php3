...
function ListaCursos($ref_periodo, $data_geracao)
{
   ...
   $sql = " SELECT D.id, ".
         ...
         "         get_dia_semana(E.dia_semana),".
         "         get_turno(E.turno),".
         "         count(*) ".
         " FROM matricula A, livro_matricula B, status_matricula C, disciplinas_ofer D, disciplinas_ofer_compl E ".
         ...
         "          E.dia_semana,".
         "          E.turno " .
         " ORDER BY E.dia_semana, E.turno, D.ref_campus, D.ref_curso, D.ref_disciplina";
   ...
   while( $query->MoveNext() )
   {
     ...
     if ($i == 1)
     {
         echo ("<td bgcolor=\"#000099\" colspan=\"5\" height=\"28\" align=\"center\"><font size=\"3\" face=\"Verdana, Arial, Helvetica, sans-serif\" color=\"#FFFFFF\"><b>Número de Matriculados por Ocorrência e Curso</b></font></td>");
         echo ("<tr>");
