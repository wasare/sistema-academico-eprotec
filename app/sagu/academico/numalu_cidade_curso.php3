...
<?
function ListaCidades($id_periodo, $disciplina)
{
   $conn = new Connection;
   ...
   $sql = " select get_cidade_pessoa(A.ref_pessoa), " .
          ...
          "       B.fl_in_lm = 'f' " .
          " group by get_cidade_pessoa(A.ref_pessoa), A.ref_curso_atual, A.ref_campus_atual " .
          " order by A.ref_curso_atual, A.ref_campus_atual, get_cidade(get_cidade_pessoa(A.ref_pessoa)) ;  " ;
...
<?
   ListaCidades($ref_periodo, $disciplina);
?>
<div align="center"> 
