...
{
  global $pnome, $snome, $so_prof, $hasmore, $g_pessoas_list;
  global $like;
...
<form method="post" action="lista_pessoas_juridicas.php3" name="selecao">
  <div align="center"> 
    <table width="490" border="0" cellspacing="0" cellpadding="2">
      <tr bgcolor="#0066CC"> 
        <td colspan="6" height="28" align="center">
          <b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FFFFFF">Localiza&ccedil;&atilde;o de Pessoas</font></b>
        </td>
      </tr>
      <tr> 
        <td>&nbsp;</td>
      ...
      <tr> 
        <td>&nbsp;</td>
        <td><input type="text" name="pnome" size="20" maxlength="45" value="<?echo($pnome)?>"></td>
        <td><input type="text" name="snome" size="20" maxlength="45" value="<?echo($snome)?>"></td>
