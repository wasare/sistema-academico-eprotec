...
<form method="post" name="myform" action="lista_disciplinas_nome.php3">
  ...
  <table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
    <tr bgcolor="#CCCCCC"> 
      ...
      <td width="35%"> <font face="Arial, Helvetica, sans-serif" size="2" color="#000000">Di&aacute;rio / Disciplina / Professor</font></td>
...
*/
  ...
  if ( $desc != '' )
    $where .= " and lower(to_ascii(B.descricao_disciplina)) SIMILAR TO lower(to_ascii('$desc%'))";
