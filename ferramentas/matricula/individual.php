  ...
  <table width="778" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="400" valign="top" class="corpo">
  	  <div align="center">
	    <!-- InstanceBeginEditable name="info" --><form method="post" action="#">
<table border="0" cellpadding="0" cellspacing="0" class="pesquisa">
<tbody>
  <tr>
    <th colspan="3">Matrícula e Alteração de Matriculao por Aluno</th>
    </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td colspan="3"><strong>Curso:</strong> Técnico em Informática Integrado ao Ensino Médio<br />
      <strong>Semestre:</strong> 1/2008<br />
      <strong>Aluno:</strong> Christiane dos Santos Pereira<br /><hr />    </td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="center" valign="middle">&nbsp;</td>
