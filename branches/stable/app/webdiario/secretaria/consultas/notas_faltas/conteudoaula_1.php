...
<body bgcolor="#FFFFFF" text="#000000"><table width="100%" border="0">
  <tr>
    <td><div align="center"><font color="#990000" size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>Consulta 
        de Conte&uacute;do de Aula</strong></font></div></td>
  </tr>
</table><center>
<div align="left"><br>
  <?
		print("<form name=\"change_periodo\" method=\"get\" action=\"conteudoaula_1.php\">
	 ...
	 if ($_GET["getperiodo"] != "")  {
    	...
    	print("<form enctype=\"multipart/form-data\" name=\"change_curso\" method=\"post\" action=\"print_historico.php\">
