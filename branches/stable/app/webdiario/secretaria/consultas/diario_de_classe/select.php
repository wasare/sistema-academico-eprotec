...
<div align="left"><br>
  <?
		print("<form name=\"change_periodo\" method=\"get\" action=\"select.php\">
...
if ($_GET["getperiodo"] != "") {
	...
	print("<form name=\"change_disciplina\" method=\"get\" action=\"select.php\">
        <input type=\"hidden\" name=\"id\" value=\"$identificacao\">
