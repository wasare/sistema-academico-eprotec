...
<div align="left"><br>
  <?
		print("<form name=\"change_periodo\" method=\"get\" action=\"select_pre.php\">
...
if ($_GET["getperiodo"] != "") {
	...
	print("<form name=\"change_disciplina\" method=\"get\" action=\"select_pre.php\">
        <input type=\"hidden\" name=\"id\" value=\"$identificacao\">
...
if ($_GET["getdisciplina"] != "") {
	...
	$getdisciplina=$_GET["getdisciplina"];
        print("<form name=\"send\" method=\"post\" action=\"make_pre.php\">
        <input type=\"hidden\" name=\"id\" value=\"$identificacao\">
        <input type=\"hidden\" name=\"getperiodo\" value=\"$getperiodo\">
