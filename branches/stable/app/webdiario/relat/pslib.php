...
{
  if ($file=='help') {
    echo("<br><b>PSLib HELP:</b> Function PS_begin_page(param1, param2) <br>");
    echo("param1 = ps file name <br>");
    echo("param2 = page number <br>");
    return("");
  }
...
{
  if ($file=='help') {
    echo("<br><b>PSLib HELP:</b> Function PS_close(param1) <br>");
    echo("param1 = ps file name <br>");
    return("");
  }
...
function PS_open($file, $author, $title, $orientation)
{
  if ($file=='help')
  {
    ...
    echo("param4 = orientation: Portrait, Landscape <br><br>");
    return("");
  }
  ...
  if (empty($orientation)) {
    echo("<br><b>PSLib Warning:</b> Function PS_open - Missing parameter: 4 (orientation. Assuming Portrait) <br>");
...
{
  if (empty($file))
    echo("<br><b>PSLib Warning:</b> Function PS_circ - Missing parameter: 1 (file name) <br>");

  if (empty($xcoord))
    echo("<br><b>PSLib Warning:</b> Function PS_circ - Missing parameter: 2 (xcoord) <br>");

  if (empty($ycoord))
    echo("<br><b>PSLib Warning:</b> Function PS_circ - Missing parameter: 3 (ycoord) <br>");

  if (empty($raio))
    echo("<br><b>PSLib Warning:</b> Function PS_circ - Missing parameter: 4 (raio) <br>");

  if (empty($angulo_ini))
    echo("<br><b>PSLib Warning:</b> Function PS_circ - Missing parameter: 5 (angulo_ini) <br>");

  if (empty($angulo_fim))
    echo("<br><b>PSLib Warning:</b> Function PS_circ - Missing parameter: 6 (angulo_fim) <br>");

  if (empty($linewidth))
    echo("<br><b>PSLib Warning:</b> Function PS_circ - Missing parameter: 7 (linewidth) <br>");
...
{
  if (empty($file))
    echo("<br><b>PSLib Warning:</b> Function PS_show_xy_font_quebrado - Missing parameter: 1 (file name) <br>");

  if (empty($text))
    echo("<br><b>PSLib Warning:</b> Function PS_show_xy_font_quebrado - Missing parameter: 2 (text) <br>");

  if (empty($xcoord))
    echo("<br><b>PSLib Warning:</b> Function PS_show_xy_font_quebrado - Missing parameter: 3 (xcoord) <br>");

  if (empty($ycoord))
    echo("<br><b>PSLib Warning:</b> Function PS_show_xy_font_quebrado - Missing parameter: 4 (ycoord) <br>");

  if (empty($font_name))
    echo("<br><b>PSLib Warning:</b> Function PS_show_xy_font_quebrado - Missing parameter: 5 (font_name) <br>");

  if (empty($font_size))
    echo("<br><b>PSLib Warning:</b> Function PS_show_xy_font_quebrado - Missing parameter: 6 (font_size) <br>");

  if (intval($font_size) == 0)
    echo("<br><b>PSLib Warning:</b> Function PS_show_xy_font_quebrado - Incorrect value: parameter 6 (font_size) <br>");

  if (empty($n_char))
    echo("<br><b>PSLib Warning:</b> Function PS_show_xy_font_quebrado - Missing parameter: 7 (n_char) <br>");

  if (empty($increment))
    echo("<br><b>PSLib Warning:</b> Function PS_show_xy_font_quebrado - Missing parameter: 8 (increment) <br>");
