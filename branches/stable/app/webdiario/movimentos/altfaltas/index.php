<?php
setcookie ("excluichamada", "0", time( )-9999);
?>
<html>
<head>
<title>Exclusão de Cahamadas</title>
          ...
          <tr>
            <td width="546" height="81">
              <table width="253" border="0" align="center" height="93">
                <tr bgcolor="#FFFFFF"> 
                  <td colspan="2" height="20" class="login"> <div align="center"><font color="#990000" size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>Exclus&atilde;o 
                      de Chamadas</strong></font></div></td>
                </tr>
                <tr> 
              ...
              <p align="center"><strong><font color="#000099">Acesso permitido 
                somente &agrave; admistradores do sistema e secretaria !</font></strong></p></td>
          </tr>
        </table>
      </td>
    </tr>
