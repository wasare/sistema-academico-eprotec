...
<body bgcolor="#FFFFFF">
<form method="post" action="lista_alunos_novatos.php" name="form1" target="_blank">
<h2>Listagem de Alunos Novatos</h2>
<span class="style1">Lista todos os alunos com v&iacute;nculo no curso relacionando pelo per&iacute;odo inicial do aluno no curso. </span>
<br />
<br />
...
<table width="637" cellpadding="0" cellspacing="0" bgcolor="#E6E6E6" class="pesquisa">
    ...
    <tr>
        ...
        <td><input name="turma" type="text" id="turma" size="10" />
           <span class="style1">Caso n&atilde;o preenchido exibir&aacute; todas.</span>
        </td>
    </tr>
    <tr>
        <td colspan="2">&nbsp;</td>
