...
<!--COMPONENTES AJAX DA PAGINA -->
    <script src="js/ajax/frmOperador_ajax.js" type="text/javascript"></script>
    <style type="text/css">
<!--
...
<body>
    ...
    <table align="center" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td valign="top">
            <form id="frmOperador" name="frmOperador" method="post" action="frmOperador_exec.php">
...
<tr>
                    ...
                    <tr>
                        <td>
                                ...
                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td  height="36"><b>&nbsp;&nbsp;&nbsp;CADASTRO DE OPERADORES DO SISTEMA  <span class="style22">(pressione ENTER sobre a op&ccedil;&atilde;o desejada para alterar)</span></b></td>
                                  </tr>
                                  <tr>
        ...
        onclick="Dialog.alert({url: 'frmOperadorAlteracao.php?metodo=novo&codigo=', options: {method: 'get'}}, {className: 'alphacube', width:430, okLabel: 'Cancelar'});" />                                       
&nbsp;&nbsp;&nbsp;                                              </td>
                   ...
                   <!-- FIM TABELA COMPROVACAO -->
                                 <script>
                                        	function doOnEnterComp(rowId)
											{
										        ...
										        urlpassada = 'frmOperadorAlteracao.php?metodo=altera&codigo=' + codigo;
											...
											{												
												codigo = grid.cells(rowId,0).getValue();												
												Dialog.confirm('<center><b>Est&aacute; opera&ccedil;&atilde;o eliminar&aacute; todos os registros relacionados a este cadastro no sistema. Tem certeza que deseja continuar?</b></center>', {width:300, okLabel: 'Sim', cancelLabel:'N&atilde;o', buttonClass: 'myButtonClass', id: 'frmMessagem', cancel:function(win) {debug('cancel confirm panel')}, ok:function(win) {submitForm('frmOperador','excluir',codigo); return true;} });
									        	return false;
											}
											
											function doOnCheck(rowId,cellInd,state)
											{	
												window.location.href = 'frmOperador_exec.php?codigo='+ grid.cells(rowId,0).getValue()+'&metodo=setaacesso&estado='+state;
												
											}
									
											grid = new dhtmlXGridObject('grid');
											grid.setImagePath("imagens/datagrid/");
											grid.setHeader("Código, Nome, Perfil, Acesso");
											grid.setInitWidths("70,*,100,70");
											grid.setColAlign("center, right, right, center");
											grid.setColTypes("ro,ro,ro,ch");
											...
											grid.init();
											grid.setSkin("light");
											grid.loadXML("frmOperador_exec.php?metodo=carregagrid&codigo=");
										</script>
