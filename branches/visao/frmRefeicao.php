...
<body>
    ...
    <table align="center" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td valign="top">
            <form id="frmRefeicao" name="frmRefeicao" method="post" action="frmRefeicao_exec.php">
...
<tr>
                    ...
                    <tr>
                        <td>
                                ...
                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td  height="36"><b>&nbsp;&nbsp;&nbsp;CADASTRO DE REFEI&Ccedil;&Otilde;ES&nbsp;(<span class="style22">Pressione ENTER sobre o item selecionado para alterar</span>)</b></td>
                                  </tr>
                                  <tr>
        ...
        onclick="Dialog.alert({url: 'frmRefeicaoAlteracao.php?metodo=novo&codigo=', options: {method: 'get'}}, {className: 'alphacube', width:430, okLabel: 'Cancelar'});" />                                       
                                        &nbsp;&nbsp;&nbsp;
                                              </td>
                                ...
                                <!-- FIM TABELA COMPROVACAO -->
                                 <script>
                                        	function doOnEnterComp(rowId)
											{
										        ...
										        urlpassada = 'frmRefeicaoAlteracao.php?metodo=altera&codigo=' + codigo;
											...
											{												
												codigo = grid.cells(rowId,0).getValue();												
												Dialog.confirm('<center><b>Est&aacute; opera&ccedil;&atilde;o eliminar&aacute; todos os registros relacionados a este cadastro no sistema. Tem certeza que deseja continuar?</b></center>', {width:300, okLabel: 'Sim', cancelLabel:'N&atilde;o', buttonClass: 'myButtonClass', id: 'frmMessagem', cancel:function(win) {debug('cancel confirm panel')}, ok:function(win) {submitForm('frmRefeicao','excluir',codigo); return true;} });
									        	return false;
											}

											grid = new dhtmlXGridObject('grid');
											grid.setImagePath("imagens/datagrid/");
											grid.setHeader("Código, Nome, Custo(R$), Unidade");
											grid.setInitWidths("100,*, 80, 80");
											grid.setColAlign("center, right, center, center");
											...
											grid.init();
											grid.setSkin("light");
											grid.loadXML("frmRefeicao_exec.php?metodo=carregagrid&codigo=");
										</script>
