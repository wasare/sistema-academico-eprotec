...
<body>
    ...
    <table align="center" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td valign="top">
            <form id="frmGrupo" name="frmGrupo" method="post" action="frmGrupo_exec.php">
                    ...
                    <tr>
                        <td>
                                ...
                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td  height="36"><b>&nbsp;&nbsp;&nbsp;CADASTRO DE GRUPOS&nbsp;&nbsp;(<span class="style22">Pressione ENTER sobre o item selecionado para alterar</span>)</b></td>
                                  </tr>
                                  <tr>
                                ...
                                <!-- FIM TABELA COMPROVACAO -->
                                 <script>
                                        	function doOnEnterComp(rowId)
											{
										        ...
										        urlpassada = 'frmGrupoAlteracao.php?metodo=altera&codigo=' + codigo;
											...
											grid.init();
											grid.setSkin("light");
											grid.loadXML("frmGrupo_exec.php?metodo=carregagrid&codigo=");
										</script>
