...
<!--COMPONENTES AJAX DA PAGINA -->
    <script src="js/ajax/frmMinhasConsultas_ajax.js" type="text/javascript"></script>
    <style type="text/css">
<!--
...
<body>
    ...
    <table align="center" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td valign="top">
            <form id="frmMinhasConsultas" name="frmMinhasConsultas" method="post" action="frmMinhasConsultas_exec.php">
...
<tr>
                    ...
                    <tr>
                        <td>
                                ...
                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td  height="36"><b>&nbsp;&nbsp;&nbsp;MINHAS CONSULTAS</b></td>
                                  </tr>
                                  <tr>
        ...
        onclick="Dialog.alert({url: 'frmGrupoAlteracao.php?metodo=novo&codigo=', options: {method: 'get'}}, {className: 'alphacube', width:430, okLabel: 'Cancelar'});" />                                       -->
                                        &nbsp;&nbsp;&nbsp;
                                              </td>
                                ...
                                <!-- FIM TABELA COMPROVACAO -->
                                 <script>
											...
											{												
												...
												Dialog.confirm('<center><b>Est&aacute; opera&ccedil;&atilde;o eliminar&aacute; este relat&oacute;rio. Tem certeza que deseja continuar?</b></center>', {width:300, okLabel: 'Sim', cancelLabel:'N&atilde;o', buttonClass: 'myButtonClass', id: 'frmMessagem', cancel:function(win) {debug('cancel confirm panel')}, ok:function(win) {submitForm('frmMinhasConsultas','excluir',codigo); return true;} });
									        	return false;
											}
											...
											grid.init();
											grid.setSkin("light");
											grid.loadXML("frmMinhasConsultas_exec.php?metodo=carregagrid&codigo=");
										</script>
