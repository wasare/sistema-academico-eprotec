...
class gtiRelatorio extends FPDF
{
	...
	public function Header()
	{
		...
		$this->Image('../visao/imagens/logoprato.jpg',160,10,40);

	    $this->SetFont('Arial','B',10);

	    $this->Cell(201,10,'PRATO - Ponto Automatizado de Refeitório',0,0,'L');
	    $this->Ln(5);

	    $this->Cell(205,10,'INSTITUTO FEDERAL MINAS GERAIS - CAMPUS BAMBUÍ',0,0,'L');
	    $this->Ln(2);
